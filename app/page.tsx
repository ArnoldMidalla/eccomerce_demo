...
const products = [
  ...
  },
  {
    ...
    price: 450,
    image:
      "https://images.unsplash.com/photo-1611312449412-6cefac5dc3e4?w=400&h=400&fit=crop",
  },
  {
    id: 22,
...
const brands = ["KITH", "NIKE", "NEW BALANCE", "ADIDAS", "ASICS", "VANS"];
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden lg:flex items-center gap-8 mx-auto">
              {categories.map((cat) => (
                <a key={cat} href="#" className="nav-link">
                  {cat}
                </a>
              ))}
            </nav>
